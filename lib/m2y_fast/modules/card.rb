module M2yFast
  class Card < Base
    ...
    def self.request_card(body)
      ...
      full_response(XmlResponseParser.request_card_response(response.body, body), xml, response.body)
    end
    ...
    def self.register_password(card_id, encrypted_password)
      ...
      full_response(XmlResponseParser.register_password_response(response.body), xml, response.body)
    end
    ...
    def self.block_card(card_id)
      ...
      full_response(XmlResponseParser.block_card_response(response.body), xml, response.body)
    end
    ...
    def self.validate_password(card_id, password)
      ...
      full_response(XmlResponseParser.validate_password_response(response.body), xml, response.body)
    end
    ...
    def self.update_password(body)
      ...
      full_response(XmlResponseParser.update_password_response(response.body), xml, response.body)
    end
    ...
    def self.activate_card(card_id)
      ...
      full_response(XmlResponseParser.activate_card_response(response.body), xml, response.body)
    end
    ...
    def self.check_card(card_id)
      ...
      full_response(XmlResponseParser.check_card_response(response.body), xml, response.body)
    end
    ...
    def self.check_cvv(body)
      ...
      full_response(XmlResponseParser.check_cvv_response(response.body), xml, response.body)
    end
    ...
    def self.card_limit(card_id)
      ...
      full_response(XmlResponseParser.card_limit_response(response.body), xml, response.body)
    end
    ...
    def self.recall_password(card_id)
      ...
      full_response(XmlResponseParser.recall_password_response(response.body), xml, response.body)
    end
    ...
    def self.update_limit(body)
      ...
      full_response(XmlResponseParser.update_limit_response(response.body), xml, response.body)
    end
    ...
    def self.best_day_for_shopping(card_id)
      ...
      full_response(XmlResponseParser.best_day_for_shopping_response(response.body), xml, response.body)
    end
