module M2yFast
  class VirtualCard < Base
    ...
    def self.request_virtual_card(body)
      ...
      full_response(VirtualCardXmlResponseParser.request_virtual_card_response(response.body, body), xml, response.body, :cadastro_cartao_virtual)
    end
    ...
    def show_virtual_card(card_number)
      ...
      full_response(VirtualCardXmlResponseParser.show_virtual_card_response(response.body, body), xml, response.body, :cartao_virtual_cert)
    end
  end
end